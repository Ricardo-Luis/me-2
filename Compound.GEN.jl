...
TwoColumnWideLeft(md"`Compound.GEN.jl`", md"`Last update: 11·09·2026`")
...
# ╔═╡ 717a2824-c2b4-415e-a36d-277ccfdc4ab2
let
# raw_url -> on github draw.io file click the "Raw" button (top right, of file view) and then copy the URL from your browser address bar:
	raw_url = "https://raw.githubusercontent.com/Ricardo-Luis/me-2/refs/heads/main/draw/Compound.GEN/compound.gen.drawio"
...
md"""
 $$R_{exc}:$$ $(@bind Rexc PlutoUI.Slider(Rd:(E₀_1500[2,1]/Iexc[2,1]), default=Rd, show_value=true)) $$\Omega$$
"""
...
!!! info "Atividade interativa"
	...
	\
	👉 Analise a trajetória do ponto de funcionamento (característica externa), atuando no _slider_ $\rm{Carga}$ (corrente). \
	
	1. Para uma dada situação de carga verifique o que sucede ao ponto de funcionamento do gerador $(I, U)$ para um aumento de velocidade, atuando no _slider_ $\rm{Velocidade}$;

	2. Idem, atuando no _slider_ $R_{\rm{campo}}$.
...
# ╔═╡ 410b0c87-117a-4d92-9e75-24a6b72d2bc8
md"""
