...
---
$$
\colorbox{Bittersweet}{\textcolor{white}{\textbf{Força Eletromotriz da Máquina de Corrente Contínua}}}$$
---
"""
...
Substituindo $(4)$ em $(3)$, vem $(5)$:

$\tag{5}
B=\frac{p \: \phi}{\pi \: r \: l}$

Substituindo $(5)$ e $(2)$ em $(1)$, tém-se $(6)$ 
