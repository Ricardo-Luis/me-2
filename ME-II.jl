...
if lang == "pt"
	md"**Fig. 1 - Domínios das competências**, [^1]."
elseif lang == "en"
	md"**Fig. 1 - Competency domains**, [^1]."
end
...
**Fig. 2 - Aplicação dos princípios FAIR, [^2]**
""")
	elseif lang == "en"
	...
	![](https://www.ub.uzh.ch/dam/jcr:0417c862-6463-465e-8f3c-b4fc585cb6e0/FAIR-data-principles.png)
	**Fig. 2 - Application of FAIR principles, [^2]**
	""")
	end
end
...
md"""
[^1]: Tidema, [A visual representation of Bloom's revised taxonomy, with indications of possible classroom activities associated with each level.](https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Bloom%27s_revised_taxonomy.svg/512px-Bloom%27s_revised_taxonomy.svg.png?20240919191759), [CC BY 4.0](https://creativecommons.org/licenses/by/4.0), via *Wikimedia Commons*.
...
manifest_format = "2.1"
project_hash = "b07613393f9d17a7cac1923c0fdf5b06d2afe795"
