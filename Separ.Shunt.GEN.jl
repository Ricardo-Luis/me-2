...
TwoColumnWideLeft(md"`Separ.Shunt.GEN.jl`", md"`Last update: 11·09·2026`")
...
md"""
Velocidade: $(@bind rpm PlutoUI.Slider(500:10:2000, default=1500, show_value=true)) rpm
"""
...
md"""
$\textbf{Gerador de excitação separada}$
| | |
|:---:|:---:|
| $$I_{{ex}}:$$ $(@bind Icampo PlutoUI.Slider(0:0.01:1.5, default=Id00, show_value=true)) $$\rm{A}\qquad$$ | $$\qquad R_{\rm{carga}}:$$ $(@bind Rcarga1 PlutoUI.Slider(1:1:1000, default=20, show_value=true)) $$\Omega$$ |
...
begin
	...
	P1=plot(I,Uspeed, title="U=f(I)", xlabel = "I(A)", ylabel="U(V)", 
			ylims=(0,420), lw=3, label="U=f(I)")
	
	plot!(I, Rcarga1*I, xlims=(0,30),ylims=(0,400), 
			linestyle=:dash, label="Reta de Carga=$(Rcarga1)Ω", legend=:best)
...
!!! info "Atividade interativa"
	...
	👉 Arraste o *slider* de "Velocidade" utilizado anteriormente, para junto das curvas características do gerador *shunt*:
...
md"""
$\textbf{Gerador de excitação derivação}$
| | |
|:---:|:---:|
| $$R_{{exc}}:$$ $(@bind Rexc PlutoUI.Slider(300/1.5:1:Rcrítica, default=356, show_value=true)) $$\Omega\qquad$$ | $$\qquad R_{\rm{carga}}:$$ $(@bind Rcarga2 PlutoUI.Slider(0:1:1000, default=20, show_value=true)) $$\Omega$$ |
...
manifest_format = "2.1"
project_hash = "ebc6277d1c731ec159979ab9b05c7f0bdc256c60"
...
git-tree-sha1 = "b50c29be50182f956925dfe43ccb07074df98a09"
registries = "General"
