...
TwoColumnWideLeft(md"`SeriesMotor.jl`", md"`Last update: 11·09·2026`")
...
md"""
 $$R_{cs}:$$ $(@bind Rcs PlutoUI.Slider(0.05:0.01:4, default=4, show_value=true)) $$\Omega$$
"""
...
|  |  |
|:--:|:--|
|  | This notebook, [SeriesMotor.jl](https://ricardo-luis.github.io/me-2/SeriesMotor.html), is part of the collection "[_Notebooks_ Computacionais Aplicados a Máquinas Elétricas II](https://ricardo-luis.github.io/me-2/)" by Ricardo Luís. |
