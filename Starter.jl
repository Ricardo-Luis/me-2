...
TwoColumnWideLeft(md"`Starter.jl`", md"`Last update: 11·09·2026`")
...
# ╔═╡ 70965163-ca31-4e50-a375-fc502c6761bb
md"""
A partir da análise da [^Fig_3] procedece-se ao dimensionamento do reóstato de arranque.
"""
...
# ╔═╡ cd15a734-93c5-4d43-849f-ef2f9ea6b8a5
md"""
[^Fig_3]: Detalhe do reóstato de arranque por pontos no processo de dimensionamento.
"""
...
# ╔═╡ df0fc539-79ed-4671-a7ba-5de017c072fd
md"""
[^Fig_4]: Curvas de velocidade do motor série e representação da manobra de arranque.
"""

# ╔═╡ 0f7bfafa-c17d-4218-ad31-ab3fdd7f1dc5
md"""
Analisando o resultado apresentado na [^Fig_4], verifica-se a influência do reóstato de arranque nas curvas de velocidade do motor série. Colocando os limites para a corrente de funcionamento do motor série, torna-se possivel traçar a trajetória da manobra de arranque a partir da posição de repouso, $n=0\: \rm{rpm}$ e $R_{arr}$ no valor máximo, verificando-se o aumento gradual da velocidade e as transições nos pontos de contacto na diminuição do valor no reóstato.
"""
...
manifest_format = "2.1"
project_hash = "cccc25c5a52e921d03729e6f1ef2667d6245ebee"
